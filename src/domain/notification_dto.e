...
feature -- Change Element
    ...
    set_sent_via_email (a_name: like sent_via_email)
        -- Set 'sent_via_email' with 'a_name'.
      do
        sent_via_email := a_name
      ensure
        sent_via_email_set: sent_via_email = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass NOTIFICATION_DTO%N")
        ...
        if attached sent_via_email as l_sent_via_email then
          Result.append ("%Nsent_via_email:")
          Result.append (l_sent_via_email.out)
          Result.append ("%N")
        end
