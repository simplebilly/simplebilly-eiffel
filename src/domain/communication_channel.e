...
feature -- Enum
 ...
 val_email: COMMUNICATION_CHANNEL
    once
      create Result
      Result.set_value ("email")
    end

 val_call: COMMUNICATION_CHANNEL
    once
      create Result
      Result.set_value ("call")
    end

 val_meeting: COMMUNICATION_CHANNEL
    once
      create Result
      Result.set_value ("meeting")
    end

 val_chat: COMMUNICATION_CHANNEL
    once
      create Result
      Result.set_value ("chat")
    end

 val_note: COMMUNICATION_CHANNEL
    once
      create Result
      Result.set_value ("note")
    end
