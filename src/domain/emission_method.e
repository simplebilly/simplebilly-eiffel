...
feature -- Enum
 ...
 val_activity: EMISSION_METHOD
    once
      create Result
      Result.set_value ("activity")
    end

 val_spend: EMISSION_METHOD
    once
      create Result
      Result.set_value ("spend")
    end

 val_supplier: EMISSION_METHOD
    once
      create Result
      Result.set_value ("supplier")
    end
