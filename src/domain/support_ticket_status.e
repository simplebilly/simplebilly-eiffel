...
feature -- Enum
 ...
 val_open: SUPPORT_TICKET_STATUS
    once
      create Result
      Result.set_value ("open")
    end

 val_awaiting_reply: SUPPORT_TICKET_STATUS
    once
      create Result
      Result.set_value ("awaiting_reply")
    end

 val_resolved: SUPPORT_TICKET_STATUS
    once
      create Result
      Result.set_value ("resolved")
    end

 val_closed: SUPPORT_TICKET_STATUS
    once
      create Result
