...
class PRINT_DELIVERY_NOTE_RESPONSE
...
feature -- Change Element
    ...
    set_pdf_url (a_name: like pdf_url)
        -- Set 'pdf_url' with 'a_name'.
      do
        pdf_url := a_name
      ensure
        pdf_url_set: pdf_url = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass PRINT_DELIVERY_NOTE_RESPONSE%N")
        if attached message as l_message then
          Result.append ("%Nmessage:")
          Result.append (l_message.out)
          Result.append ("%N")
        end
        if attached pdf_url as l_pdf_url then
          Result.append ("%Npdf_url:")
          Result.append (l_pdf_url.out)
          Result.append ("%N")
        end
