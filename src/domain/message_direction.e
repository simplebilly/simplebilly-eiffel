...
feature -- Enum
 ...
 val_inbound: MESSAGE_DIRECTION
    once
      create Result
      Result.set_value ("inbound")
    end

 val_outbound: MESSAGE_DIRECTION
    once
      create Result
      Result.set_value ("outbound")
    end

 val_internal: MESSAGE_DIRECTION
    once
      create Result
