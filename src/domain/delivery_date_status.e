...
feature -- Enum
 ...
 val_promised: DELIVERY_DATE_STATUS
    once
      create Result
      Result.set_value ("promised")
    end

 val_confirmed: DELIVERY_DATE_STATUS
    once
      create Result
      Result.set_value ("confirmed")
    end

 val_rescheduled: DELIVERY_DATE_STATUS
    once
      create Result
      Result.set_value ("rescheduled")
    end

 val_fulfilled: DELIVERY_DATE_STATUS
    once
      create Result
      Result.set_value ("fulfilled")
    end

 val_late: DELIVERY_DATE_STATUS
    once
      create Result
      Result.set_value ("late")
    end

 val_cancelled: DELIVERY_DATE_STATUS
    once
      create Result
