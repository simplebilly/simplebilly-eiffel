...
feature -- Enum
 ...
 val_goods_receipt: REFERENCE_TYPE
    once
      create Result
      Result.set_value ("goods_receipt")
    end

 val_production_order: REFERENCE_TYPE
    once
      create Result
      Result.set_value ("production_order")
    end

 val_transfer_in: REFERENCE_TYPE
    once
      create Result
      Result.set_value ("transfer_in")
    end

 val_stock_transfer: REFERENCE_TYPE
    once
      create Result
      Result.set_value ("stock_transfer")
    end

 val_return_order: REFERENCE_TYPE
    once
      create Result
      Result.set_value ("return_order")
    end

 val_inventory_count: REFERENCE_TYPE
    once
      create Result
      Result.set_value ("inventory_count")
    end
