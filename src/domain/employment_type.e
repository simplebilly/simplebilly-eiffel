...
feature -- Enum
 ...
 val_fulltime: EMPLOYMENT_TYPE
    once
      create Result
      Result.set_value ("fulltime")
    end

 val_parttime: EMPLOYMENT_TYPE
    once
      create Result
      Result.set_value ("parttime")
    end

 val_contract: EMPLOYMENT_TYPE
    once
      create Result
      Result.set_value ("contract")
    end

 val_internship: EMPLOYMENT_TYPE
    once
      create Result
      Result.set_value ("internship")
    end

 val_temporary: EMPLOYMENT_TYPE
    once
      create Result
      Result.set_value ("temporary")
    end
