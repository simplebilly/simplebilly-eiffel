...
class SERVICE_ASSIGNMENT_STATUS
...
feature -- Enum
 ...
 val_planned: SERVICE_ASSIGNMENT_STATUS
    once
      create Result
      Result.set_value ("planned")
    end

 val_confirmed: SERVICE_ASSIGNMENT_STATUS
    once
      create Result
      Result.set_value ("confirmed")
    end

 val_en_route: SERVICE_ASSIGNMENT_STATUS
    once
      create Result
      Result.set_value ("en_route")
    end

 val_in_progress: SERVICE_ASSIGNMENT_STATUS
    once
      create Result
      Result.set_value ("in_progress")
    end

 val_completed: SERVICE_ASSIGNMENT_STATUS
    once
      create Result
      Result.set_value ("completed")
    end

 val_cancelled: SERVICE_ASSIGNMENT_STATUS
    once
      create Result
