...
feature -- Enum
 ...
 val_gmbh: COMPANY_TYPE
    once
      create Result
      Result.set_value ("gmbh")
    end
 ...
 val_einzelhaendler: COMPANY_TYPE
    once
      create Result
      Result.set_value ("einzelhaendler")
    end

 val_freiberufler: COMPANY_TYPE
    once
      create Result
      Result.set_value ("freiberufler")
    end
