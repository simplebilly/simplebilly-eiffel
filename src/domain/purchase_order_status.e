...
feature -- Enum
 ...
 val_draft: PURCHASE_ORDER_STATUS
    once
      create Result
      Result.set_value ("draft")
    end

 val_ordered: PURCHASE_ORDER_STATUS
    once
      create Result
      Result.set_value ("ordered")
    end

 val_partially_received: PURCHASE_ORDER_STATUS
    once
      create Result
      Result.set_value ("partially_received")
    end

 val_received: PURCHASE_ORDER_STATUS
    once
      create Result
      Result.set_value ("received")
    end

 val_cancelled: PURCHASE_ORDER_STATUS
    once
      create Result
