...
feature -- Enum
 ...
 val_required: ASSIGNMENT_STATUS
    once
      create Result
      Result.set_value ("required")
    end

 val_completed: ASSIGNMENT_STATUS
    once
      create Result
      Result.set_value ("completed")
    end

 val_overdue: ASSIGNMENT_STATUS
    once
      create Result
      Result.set_value ("overdue")
    end

 val_waived: ASSIGNMENT_STATUS
    once
      create Result
      Result.set_value ("waived")
    end
