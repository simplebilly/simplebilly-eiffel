...
feature -- Enum
 ...
 val_requested: RETURN_ORDER_STATUS
    once
      create Result
      Result.set_value ("requested")
    end

 val_received: RETURN_ORDER_STATUS
    once
      create Result
      Result.set_value ("received")
    end

 val_inspected: RETURN_ORDER_STATUS
    once
      create Result
      Result.set_value ("inspected")
    end

 val_restocked: RETURN_ORDER_STATUS
    once
      create Result
      Result.set_value ("restocked")
    end

 val_closed: RETURN_ORDER_STATUS
    once
      create Result
