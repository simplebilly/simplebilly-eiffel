...
feature -- Enum
 ...
 val_kein: INSTITUTE_TYPE
    once
      create Result
      Result.set_value ("kein")
    end

 val_kreditinstitut: INSTITUTE_TYPE
    once
      create Result
      Result.set_value ("kreditinstitut")
    end

 val_finanzdienstleistungsinstitut: INSTITUTE_TYPE
    once
      create Result
      Result.set_value ("finanzdienstleistungsinstitut")
    end

 val_finanzunternehmen: INSTITUTE_TYPE
    once
      create Result
      Result.set_value ("finanzunternehmen")
    end

 val_versicherung: INSTITUTE_TYPE
    once
      create Result
      Result.set_value ("versicherung")
    end
