...
feature -- Enum
 ...
 val_draft: INVENTORY_COUNT_STATUS
    once
      create Result
      Result.set_value ("draft")
    end

 val_counting: INVENTORY_COUNT_STATUS
    once
      create Result
      Result.set_value ("counting")
    end

 val_reviewed: INVENTORY_COUNT_STATUS
    once
      create Result
      Result.set_value ("reviewed")
    end

 val_posted: INVENTORY_COUNT_STATUS
    once
      create Result
