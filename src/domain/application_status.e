...
feature -- Enum
 ...
 val_new: APPLICATION_STATUS
    once
      create Result
      Result.set_value ("new")
    end

 val_reviewing: APPLICATION_STATUS
    once
      create Result
      Result.set_value ("reviewing")
    end

 val_interview: APPLICATION_STATUS
    once
      create Result
      Result.set_value ("interview")
    end

 val_hired: APPLICATION_STATUS
    once
      create Result
      Result.set_value ("hired")
    end

 val_rejected: APPLICATION_STATUS
    once
      create Result
