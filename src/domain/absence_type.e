...
feature -- Enum
 ...
 val_vacation: ABSENCE_TYPE
    once
      create Result
      Result.set_value ("vacation")
    end

 val_sick: ABSENCE_TYPE
    once
      create Result
      Result.set_value ("sick")
    end

 val_sabbatical: ABSENCE_TYPE
    once
      create Result
      Result.set_value ("sabbatical")
    end

 val_parental: ABSENCE_TYPE
    once
      create Result
      Result.set_value ("parental")
    end

 val_other: ABSENCE_TYPE
    once
      create Result
