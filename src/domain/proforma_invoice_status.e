...
feature -- Enum
 ...
 val_draft: PROFORMA_INVOICE_STATUS
    once
      create Result
      Result.set_value ("draft")
    end

 val_sent: PROFORMA_INVOICE_STATUS
    once
      create Result
      Result.set_value ("sent")
    end

 val_converted: PROFORMA_INVOICE_STATUS
    once
      create Result
      Result.set_value ("converted")
    end
