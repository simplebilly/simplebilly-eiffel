...
feature -- Enum
 ...
 val_draft: SUPPLIER_INVOICE_STATUS
    once
      create Result
      Result.set_value ("draft")
    end

 val_matched: SUPPLIER_INVOICE_STATUS
    once
      create Result
      Result.set_value ("matched")
    end

 val_has_variances: SUPPLIER_INVOICE_STATUS
    once
      create Result
      Result.set_value ("has_variances")
    end

 val_posted: SUPPLIER_INVOICE_STATUS
    once
      create Result
      Result.set_value ("posted")
    end

 val_cancelled: SUPPLIER_INVOICE_STATUS
    once
      create Result
