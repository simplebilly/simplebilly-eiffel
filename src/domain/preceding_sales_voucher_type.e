...
class PRECEDING_SALES_VOUCHER_TYPE
...
feature -- Enum
 ...
 val_order_confirmation: PRECEDING_SALES_VOUCHER_TYPE
    once
      create Result
      Result.set_value ("order_confirmation")
    end

 val_quotation: PRECEDING_SALES_VOUCHER_TYPE
    once
      create Result
      Result.set_value ("quotation")
    end

 val_proforma_invoice: PRECEDING_SALES_VOUCHER_TYPE
    once
      create Result
      Result.set_value ("proforma_invoice")
    end
