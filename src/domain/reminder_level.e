...
feature -- Enum
 ...
 val_none: REMINDER_LEVEL
    once
      create Result
      Result.set_value ("none")
    end

 val_due: REMINDER_LEVEL
    once
      create Result
      Result.set_value ("due")
    end

 val_level1: REMINDER_LEVEL
    once
      create Result
      Result.set_value ("level1")
    end

 val_level2: REMINDER_LEVEL
    once
      create Result
      Result.set_value ("level2")
    end

 val_level3: REMINDER_LEVEL
    once
      create Result
      Result.set_value ("level3")
    end
