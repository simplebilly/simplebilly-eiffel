...
feature -- API Access
	...
	offenlegung_api : detachable OFFENLEGUNG_REPORT
			-- 
			-- 
			-- 
			-- 
			-- Result OFFENLEGUNG_REPORT
		require
		local
  			l_path: STRING
		...
		do
			...
			l_path := "/api/v1/bookkeeping/offenlegung"
			...
			elseif attached { OFFENLEGUNG_REPORT } l_response.data ({ OFFENLEGUNG_REPORT }) as l_data then
				Result := l_data
			else
