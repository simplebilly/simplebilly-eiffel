...
feature -- API Access
	...
	credit_note (credit_note_id: STRING_32): detachable INVOICE
			...
			-- 
			-- 
			-- argument: credit_note_id  (required)
			-- 
			-- 
			-- Result INVOICE
		require
		...
		do
			...
			l_path := "/api/v1/credit-notes/{credit_note_id}"
			l_path.replace_substring_all ("{"+"credit_note_id"+"}", api_client.url_encode (credit_note_id.out))
	...
	download_credit_note_pdf (credit_note_id: STRING_32)
		...
		do
			...
			l_path := "/api/v1/credit-notes/{credit_note_id}/pdf"
			l_path.replace_substring_all ("{"+"credit_note_id"+"}", api_client.url_encode (credit_note_id.out))
	...
	list_credit_notes (page: INTEGER_32; page_size: INTEGER_32; search: STRING_32; include_deleted: BOOLEAN): detachable LIST [INVOICE]
			-- 
			-- 
			-- 
