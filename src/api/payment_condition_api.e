...
feature -- API Access
	...
	list_payment_conditions_api : detachable LIST [PAYMENT_CONDITION]
			-- 
			-- 
			-- 
			-- 
			-- Result LIST [PAYMENT_CONDITION]
		require
		local
  			l_path: STRING
		...
		do
			...
			l_path := "/api/v1/payment-conditions"
			...
			elseif attached { LIST [PAYMENT_CONDITION] } l_response.data ({ LIST [PAYMENT_CONDITION] }) as l_data then
				Result := l_data
			else
