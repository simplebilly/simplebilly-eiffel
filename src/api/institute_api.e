...
feature -- API Access
	...
	institute_status_api : detachable INSTITUTE_STATUS
			-- 
			-- 
			-- 
			-- 
			-- Result INSTITUTE_STATUS
		require
		local
  			l_path: STRING
		...
		do
			...
			l_path := "/api/v1/bookkeeping/institute/status"
			...
			elseif attached { INSTITUTE_STATUS } l_response.data ({ INSTITUTE_STATUS }) as l_data then
				Result := l_data
			else
