...
feature -- API Access
	...
	peppol_api (id: STRING_32): detachable PEPPOL_RESPONSE
			-- 
			-- 
			-- 
		...
		do
			...
			l_path := "/api/v1/invoices/{id}/peppol"
			...
			elseif attached { PEPPOL_RESPONSE } l_response.data ({ PEPPOL_RESPONSE }) as l_data then
				Result := l_data
			else
