...
feature -- API Access
	...
	anlage_sapi (year: INTEGER_32): detachable ANLAGE_S_ERGEBNIS
			-- 
			-- 
			-- 
		...
		do
			...
			l_path := "/api/v1/bookkeeping/anlage-s"
			...
			elseif attached { ANLAGE_S_ERGEBNIS } l_response.data ({ ANLAGE_S_ERGEBNIS }) as l_data then
				Result := l_data
			else
