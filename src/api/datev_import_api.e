...
feature -- API Access
	...
	datev_import_api (body: ANY): detachable DATEV_IMPORT_RESPONSE
			-- 
			-- 
			-- 
		...
		do
			...
			l_path := "/api/v1/bookkeeping/datev/import"
			...
			elseif attached { DATEV_IMPORT_RESPONSE } l_response.data ({ DATEV_IMPORT_RESPONSE }) as l_data then
				Result := l_data
			else
