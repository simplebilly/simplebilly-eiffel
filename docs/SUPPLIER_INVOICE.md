...
**invoice_date** | [**DATE**](DATE.md) |  | [default to null]
**invoice_number** | [**STRING_32**](STRING_32.md) |  | [default to null]
**line_items** | [**ANY**](.md) | JSON array of &#x60;{product_id, name, quantity, unitPriceNet, taxRate}&#x60;. | [default to null]
...
**status** | [**SUPPLIER_INVOICE_STATUS**](SupplierInvoiceStatus.md) | One of: draft | matched | has_variances | posted | cancelled | [default to null]
