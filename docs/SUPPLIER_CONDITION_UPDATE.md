...
------------ | ------------- | ------------- | -------------
**currency** | [**STRING_32**](STRING_32.md) | Currency for the minimum order value. | [optional] [default to null]
...
**supplier_contact_id** | [**STRING_32**](STRING_32.md) | The supplier this condition applies to (&#x60;contact_id&#x60;). References the supplier entity. | [optional] [default to null]
