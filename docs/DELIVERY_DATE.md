...
**order_number** | [**STRING_32**](STRING_32.md) | Sales order number (&#x60;order.order_number&#x60;). | [default to null]
...
**promised_date** | [**DATE**](DATE.md) | Date promised to the customer. | [default to null]
**status** | [**DELIVERY_DATE_STATUS**](DeliveryDateStatus.md) | One of: promised | confirmed | rescheduled | fulfilled | late | cancelled | [default to null]
