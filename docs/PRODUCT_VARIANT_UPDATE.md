...
**product_id** | [**UUID**](UUID.md) | The parent product this variant belongs to. References the product entity. | [optional] [default to null]
**sku** | [**STRING_32**](STRING_32.md) | Variant-specific SKU (must be unique per tenant). | [optional] [default to null]
