...
------------ | ------------- | ------------- | -------------
**activity_type** | [**ACTIVITY_TYPE**](ActivityType.md) | One of: call | email | meeting | task | note | [optional] [default to null]
...
**status** | [**ACTIVITY_STATUS**](ActivityStatus.md) | One of: open | done | cancelled | [optional] [default to null]
**subject** | [**STRING_32**](STRING_32.md) | Short subject line. | [optional] [default to null]
