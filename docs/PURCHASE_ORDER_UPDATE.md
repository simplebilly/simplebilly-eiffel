...
**order_date** | [**DATE**](DATE.md) |  | [optional] [default to null]
**po_number** | [**STRING_32**](STRING_32.md) |  | [optional] [default to null]
**status** | [**PURCHASE_ORDER_STATUS**](PurchaseOrderStatus.md) | One of: draft | ordered | partially_received | received | cancelled | [optional] [default to null]
