...
**first_message_at** | [**DATE_TIME**](DATE_TIME.md) |  | [optional] [default to null]
**last_message_at** | [**DATE_TIME**](DATE_TIME.md) |  | [optional] [default to null]
**lead_id** | [**UUID**](UUID.md) | References the lead entity. | [optional] [default to null]
**message_count** | **INTEGER_32** |  | [optional] [default to null]
**order_ref** | [**STRING_32**](STRING_32.md) |  | [optional] [default to null]
**priority** | [**TICKET_PRIORITY**](TicketPriority.md) |  | [optional] [default to null]
**resolution** | [**STRING_32**](STRING_32.md) |  | [optional] [default to null]
**status** | [**SUPPORT_TICKET_STATUS**](SupportTicketStatus.md) |  | [optional] [default to null]
