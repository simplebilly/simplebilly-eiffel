...
**description** | [**STRING_32**](STRING_32.md) | What the job is; markdown/HTML. | [optional] [default to null]
...
**required_skills** | [**ANY**](.md) | List of required skill names (JSON array of strings). | [optional] [default to null]
...
**status** | [**JOB_POSTING_STATUS**](JobPostingStatus.md) | draft | published | closed | [optional] [default to null]
