...
**channel** | [**COMMUNICATION_CHANNEL**](CommunicationChannel.md) |  | [optional] [default to null]
**contact_id** | [**STRING_32**](STRING_32.md) | The contact (customer/supplier) this communication belongs to. References the contact entity. | [optional] [default to null]
**counterparty** | [**STRING_32**](STRING_32.md) | Email/phone of the counterparty, if applicable. | [optional] [default to null]
**direction** | [**COMMUNICATION_DIRECTION**](CommunicationDirection.md) |  | [optional] [default to null]
